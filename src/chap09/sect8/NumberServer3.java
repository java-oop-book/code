 ...
 *
 * @version 3 event handler is created as an anonymous object of an anonymous class
 *
 * @author Drue Coles
 */
public class NumberServer3 extends Application {
   ...
   public void start(Stage stage) {
      ...
      button.setOnAction(new EventHandler<ActionEvent>() { // anonymous object of anonymous class
         @Override
